...
class CalendarEvent(models.Model):
    ...
    lead_source = fields.Selection([('a','Website'),('b','Internal Employee'),('c','Ambassador'),('d','Business Listing'),('e','Social Media'),('f','Facebook'),('g','LinkedIn'),('h','Email'),('i','Google'),('j','Word of mouth'),('k','Employee Referral'),('l','Partner'),('m','Walk-in'),('n','Web'),('o','CTI'),('p','Other'),('q','Trade Show'),('r','Advertisement')])
    asn = fields.Char()
    student_city = fields.Char()
